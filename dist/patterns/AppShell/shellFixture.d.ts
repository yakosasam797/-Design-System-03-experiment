...
export declare const SHELL_IMPORT_WARNING = "Do not recreate Sidebar, Topbar or AppShell inside a product module. Import the canonical components from @paryatech/ui.";
